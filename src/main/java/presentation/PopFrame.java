...
public class PopFrame extends Application{
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			loader.setLocation(getClass().getResource("/FXML/Pop.fxml"));
			...
			PopFrameController controller = loader.getController();
			controller.setPopFrame(this);
		} catch (Exception e) {
			e.printStackTrace();
		}
