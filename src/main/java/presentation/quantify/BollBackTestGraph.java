...
public class BollBackTestGraph {

	public ChartPanel GetBollBackTestGraph(String section, ArrayList<String> stockPool, String begin, String end) {
		
		GetBollDataService bds = new GetBollData();
		DefaultCategoryDataset dataset = bds.GetBollBackTestGraphData(section, stockPool, begin, end);
	...
	public static void main(String[] args) {
		BollBackTestGraph mGraph = new BollBackTestGraph();
		...
		name.add("2074");		
//		name.add("2208");
		ChartPanel chart = mGraph.GetBollBackTestGraph(null, name,"1/20/14", "4/29/14");
