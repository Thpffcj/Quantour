...
public class KDJStochasticBackTestGraph {

	public ChartPanel getKDJStochasticBackTestGraph(String section, ArrayList<String> stockPool, String begin, String end) {
		
		GetKDJStochasticDataService kdjds = new GetKDJStochasticData();
		DefaultCategoryDataset dataset = kdjds.GetKDJStochasticBackTestGraphData(section, stockPool, begin, end);
	...
	public static void main(String[] args) {
		KDJStochasticBackTestGraph mGraph = new KDJStochasticBackTestGraph();
...
//		name.add("2074");		
//		name.add("2208");
		ChartPanel chart = mGraph.getKDJStochasticBackTestGraph(null, name,"10/8/13", "4/29/14");
