...
public class ChangePasswordFrame extends Application{
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			ChangePasswordFrameController controller = loader.getController();
			controller.setChangePasswordFrame(this);
		} catch (Exception e) {
			e.printStackTrace();
		}
